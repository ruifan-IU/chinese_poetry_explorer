    ...
    <form onSubmit={handleSubmit} className='flex-1 md:max-w-md'>
      <div className='relative'>
        <input
          ...
          disabled={isPending}
          className='w-full rounded-lg border border-zinc-300 bg-white px-4 py-2 pr-20 text-sm text-zinc-700 focus:border-zinc-500 focus:outline-none disabled:opacity-50'
        />
